# Apache Kudu Kubernetes Operator

Apache Kudu Kubernetes Operator based on Operator framework SDK.
...
## Description
The Kudu Operator manages Kudu clusters deployed to Kubernetes 
and automates tasks related to operating a Kudu cluster. It provides 
a full management life-cycle for Kudu, including deployment, upgrades, 
