...
type KuduStatus struct {
	// Represents the observations of a Kudu's current state.
	// Kudu.status.conditions.type are: "Available", "Progressing", and "Degraded"
	// Kudu.status.conditions.status are one of True, False, Unknown.
	// Kudu.status.conditions.reason the value should be a CamelCase string and producers of specific
	// condition types may define expected values and meanings for this field, and whether the values
	// are considered a guaranteed API.
	// Kudu.status.conditions.Message is a human readable message indicating details about the transition.
...
func init() {
	SchemeBuilder.Register(&Kudu{}, &KuduList{})
}
